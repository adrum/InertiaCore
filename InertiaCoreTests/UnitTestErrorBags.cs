...
public class UnitTestErrorBags
{
    ...
    public void Setup()
    {
        ...
        var constructor = responseType.GetConstructor(
            ...
            new[]
            {
                ...
                typeof(IInertiaSerializer), typeof(bool)
            },
            null);

        _response = (Response)constructor!.Invoke(new object[]
            { "TestComponent", new Dictionary<string, object?>(), "app", null!, _serializerMock.Object, false });
        ...
        Dictionary<string, string>? modelStateErrors)
    {
        ...
        var response = (Response)ctor!.Invoke(new object[]
            { "TestComponent", new Dictionary<string, object?>(), "app", null!, serializer.Object, false });
